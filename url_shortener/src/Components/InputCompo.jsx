    ...
    <>
      <div className='flex flex-col w-72 sm:w-[34rem] rounded-lg border-2   bg-neutral-300  justify-center items-center h-60 sm:h-72 gap-4'>
        ...
        <div className='flex gap-4 flex-col'>
          ...
          <input type="text" value={url} name="url" placeholder="Type here..." onChange={e => setUrl(e.target.value)} className='border-2 border-black rounded-lg  w-60 sm:w-96 h-12 p-2' />
        </div>
        {urlId && (
