...
function InputComponent() {
  ...
  return (
    <>
      <div className='flex flex-col  w-[34rem] rounded-lg border-2 border-black  bg-neutral-100  justify-center items-center h-72 gap-4'>
        ...
        {urlId && (
          <div className='text-md text-green-500'>URL ID: {urlId}</div>
        )}      
